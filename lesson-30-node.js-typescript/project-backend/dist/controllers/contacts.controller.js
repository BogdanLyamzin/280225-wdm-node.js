...
import { getContacts, getContactById, addContact, updateContactById, deleteContactById, } from "../services/contacts.service.js";
...
export const addContactController = async (req, res) => {
    ...
    const { id: owner } = req.user;
    const result = await addContact({ ...req.body, owner }, req.file);
